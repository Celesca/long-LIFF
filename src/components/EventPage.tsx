  ...
  return (
    <Layout showHeader headerTitle="Event Photo" showBackButton backgroundVariant="tinder">
      <div className="mx-auto min-h-[calc(100vh-120px)] max-w-lg px-4 py-6 lg:max-w-6xl lg:px-8 lg:py-8">
        ...
        <div className="relative rounded-3xl overflow-hidden mb-6 shadow-xl">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-[#FF6B4A] text-white text-xs font-bold px-2.5 py-1 rounded-full animate-pulse">
                LIVE EVENT
              </span>
        ...
        <div className="flex gap-3 mb-6">
          <button
            ...
            className={`flex-1 py-3 px-4 rounded-2xl font-semibold text-sm transition-all ${
              !showGallery 
                ? 'bg-gradient-to-r from-[#FF6B4A] to-[#E85336] text-white shadow-lg' 
          ...
          >
            รูปของฉัน
            {photos.length > 0 && (
              <span className="absolute -top-2 -right-2 w-6 h-6 bg-[#FFC857] text-white text-xs font-bold rounded-full flex items-center justify-center">
                {photos.length}
              </span>
            )}
          </button>
          ...
          <div className="space-y-4 lg:mx-auto lg:max-w-2xl">
            {!isCapturing ? (
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg text-center">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-[#FFF4EC] to-[#FFF4EC] rounded-full flex items-center justify-center">
                  <svg className="w-12 h-12 text-[#FF6B4A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  onClick={startCamera}
                  className="w-full py-4 bg-gradient-to-r from-[#FF6B4A] to-[#E85336] text-white font-bold rounded-2xl shadow-lg hover:shadow-xl active:scale-95 transition-all flex items-center justify-center gap-2"
                >
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-xl bg-black">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <div className="w-16 h-16 bg-gradient-to-br from-[#FF6B4A] to-[#E85336] rounded-full border-4 border-white" />
                    </button>
                ...
                {/* Photo Count Badge */}
                {photos.length > 0 && (
                  <div className="absolute top-4 right-4 bg-[#FF6B4A] text-white text-sm font-bold px-3 py-1.5 rounded-full shadow-lg">
                    {photos.length} รูป
                  </div>
                )}
              </div>
          ...
          <div className="space-y-4">
            {photos.length === 0 ? (
              <div className="bg-white rounded-3xl p-8 shadow-lg text-center">
                ...
                <button
                  onClick={() => setShowGallery(false)}
                  className="px-6 py-2.5 bg-gradient-to-r from-[#FF6B4A] to-[#E85336] text-white font-semibold rounded-xl active:scale-95 transition-transform"
                >
                  ถ่ายรูปเลย
                </button>
              </div>
        ...
        {/* Info Card */}
        <div className="mt-6 bg-gradient-to-br from-[#FFF4EC] to-[#FFF4EC] rounded-2xl p-4 border border-[#DDEAF3]">
          <div className="flex items-start gap-3">
            <svg className="w-5 h-5 text-[#FFC857] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18"/></svg>
            <div>
              <h4 className="font-semibold text-[#8A6A00] mb-1">เคล็ดลับ</h4>
              <p className="text-[#A37900] text-sm">
